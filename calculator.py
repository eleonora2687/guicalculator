from tkinter import *
from tkinter.messagebox import showinfofrom tkinter import *
...
class Calculator:
    ...
    def makeWidgets(self):
        ...
        reciprocal.grid(row=6, column=3)
        ...
        for j in self.lists:
            ...
            a += 1
        power = Button(root, text='x²', width=self.wid, height=self.heigh, fg='black', highlightbackground='red',
                       command=lambda: self.add('**'))
